    ...
    <section className="max-w-screen-xl mx-auto px-6 py-12 lg:flex lg:justify-between lg:items-center font-serif">
      <div className="z-10 space-y-5 text-center lg:text-left lg:w-1/2">
        ...
        <div className="flex justify-center lg:justify-start space-x-6 mt-6">
          ...
          <a className="px-6 py-3 bg-[#065a60] text-white text-lg font-bold rounded-md shadow-md hover:bg-gray-700 hover:shadow-lg hover:scale-105 hover:ring-2 hover:ring-[#32e1e6] active:scale-95 transition-transform duration-300 ease-in-out">
            <Link
