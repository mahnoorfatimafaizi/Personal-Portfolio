...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#000000] py-16 font-serif">
      <div
        className="container mx-auto px-4 flex flex-col items-center space-y-6 md:flex-row md:justify-between md:space-y-0 mt-10 opacity-0 animate-slideInUp"
      >
        <div className="text-center md:text-left">
          <p className="text-white">mahnoorf2002@gmail.com</p>
        </div>
        ...
        <div className="flex space-x-4">
          <Link href="https://github.com/mahnoorfatimafaizi" passHref>
            <div className="text-white hover:text-purple-500 text-2xl hover:scale-110 hover:rotate-12 transition-all duration-300">
              <i className="fab fa-github"></i>
            </div>
          </Link>
        ...
        <div className="flex flex-wrap justify-center md:justify-start space-x-6 text-white text-sm">
          ...
          <Link href="/projects" passHref>
            <div className="hover:underline hover:text-purple-500">Projects</div>
          </Link>
          <Link href="/contact" passHref>
            <div className="hover:underline hover:text-purple-500">Contact</div>
          </Link>
