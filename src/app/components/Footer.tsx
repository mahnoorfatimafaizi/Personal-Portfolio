...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#000000] py-16 font-serif">
      <div className="container mx-auto px-4 flex flex-col items-center space-y-6 md:flex-row md:justify-between md:space-y-0 mt-10 opacity-0 animate-slideInUp">
